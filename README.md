...
**DiGi.Scripting.Rhino** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.Scripting.CSharp.Rhino](DiGi.Scripting.CSharp.Rhino)** (Path: `DiGi.Scripting.Rhino\DiGi.Scripting.CSharp.Rhino`)
* **[DiGi.Scripting.Rhino](DiGi.Scripting.Rhino)** (Path: `DiGi.Scripting.Rhino\DiGi.Scripting.Rhino`)
